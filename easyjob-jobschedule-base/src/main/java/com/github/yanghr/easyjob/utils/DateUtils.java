...
public class DateUtils {
    ...
    /** this date format for internal use. **/
    public static final String DATEFORMAT_YYYYMMDD_LINE = "yyyy-MM-dd";
    /** this date format for internal use. **/
    public static final String DATEFORMAT_YYYYMMDDHHMMSS_LINE = "yyyy-MM-dd HH:mm:ss";
    ...
    public static DateFormat getDateFormat(String pattern) {
        return new SimpleDateFormat(pattern, getDefaultLocale());
    }
    ...
    public static Locale getDefaultLocale() {
        if(TimeZone.getDefault().getRawOffset() == (TimeZone.getTimeZone("GMT+08").getRawOffset())) {
            return Locale.CHINA;
        }
    ...
    public static void main(String[] args) {
        System.out.println((TimeZone.getTimeZone("GMT+8").getRawOffset()));
     ...
     * @throws ParseException
     */
    public static int compareDateByDay(Date date1, Date date2) throws ParseException {
        if (date1 == null) {
            date1 = future();
        }
        if (date2 == null) {
     ...
     * @throws ParseException
     */
    public static int compareDateByTimestamp(Date date1, Date date2) throws ParseException {
        if (date1 == null) {
            date1 = future();
        }
        if (date2 == null) {
     ...
     * @throws ParseException
     */
    public static int compareDateByMonth(Date date1, Date date2) throws ParseException {
        if (date1 == null) {
            date1 = future();
        }
        if (date2 == null) {
     ...
     * @throws ParseException
     */
    public static int compareDateByYear(Date date1, Date date2) throws ParseException {
        if (date1 == null) {
            date1 = future();
        }
        if (date2 == null) {
     ...
     * @throws ParseException
     */
    public static Date future() throws ParseException {
        Date date = null;
     ...
     * @throws ParseException
     */
    public static String getCurrQuarter() throws ParseException {
    ...
    /**
     * 自动解析，按照yyyy-MM-dd，yyyyMMdd，yyyy-MM-dd HH:mm:ss, yyyyMMdd HH:mm:ss的格式依次匹配.
     *
     * @param dateString 日期字段
     * @return Date
     */
    public static Date parseDate(String dateString) {
        Date result = null;
        try {
            // date = DateUtils.parseDate(jp.getText(), FORMATTER, FORMATTER_1);
            result = org.apache.commons.lang3.time.DateUtils.parseDate(dateString, "yyyy-MM-dd",
                    "yyyyMMdd", "yyyy-MM-dd HH:mm:ss", "yyyyMMdd HH:mm:ss");
    ...
    public static int getDayOfWeek(Date date) {
        ...
        return calendar.get(Calendar.DAY_OF_WEEK) - 1 == 0 ? 7
...
//    public static void main(String[] args) {
//        System.out.println(DateUtils.formatDate(DateUtils.parseDate("2020-04-20 10:25:00", DATEFORMAT_YYYYMMDDHHMMSS_LINE), DATEFORMAT_YYYYMMDDHHMMSS_LINE));
//    }
}
